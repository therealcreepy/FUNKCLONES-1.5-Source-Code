...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Perma-Zoom', "Value 1: New Zoom Effect \nValue 2: nothing,,,"],
		['No-Dark', ""],
		['Darkness', "Value 1: 0 = Pure Black, anything else has slight characters\nValue 2: N/A"],
		['Visible GF', "Value 1 = 0 has gf invis and dad visible, 1, is opposite, 2 is both visible."],
		['Classic Tails Enter', "Summon Tails."]
