...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		var menuBG:FlxSprite = new FlxSprite().loadGraphic(Paths.image('rcBg'));
		...
		for (i in 0...Achievements.achievementsStuff.length) {
			if(!Achievements.achievementsStuff[i][4] || Achievements.achievementsMap.exists(Achievements.achievementsStuff[i][2]) && !Achievements.achievementsStuff[i][4]) {
